                            ...
                            <div class="form-group  col-md-12">
                                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop" style="margin-bottom: 22px">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input type="file" class="form-input mdc-text-field__input video" id="text-field-hero-input"  name="video" >
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('submit','#form_update_video',function (e){
            e.preventDefault();
            let id = $(this).data('id');
            let method = $('#form_update_video #method').val();
            let url = $(this).attr('action');
            let formData = new FormData($('#form_update_video')[0]);
            let name = $('#edit_video_show #form_update_video #en-name').val();
