 ...
 <div class="category_btn_del" style="display: inline-block">
     <form  action="{{ route('admin.users.destroy', $user->id) }}" class="my-1 my-xl-0  " id="form_delete_users" method="post" data-id="{{$user->id}}" >
         @csrf
         @method('delete')
 ...
 <button
     class="mdc-button mdc-button--raised icon-button filled-button--success" data-toggle="modal" data-target="#edit_category" id="edit_model_users" data-url="{{route('admin.users.update',$user->id)}}" data-id="{{$user->id}}"
     data-name="{{$user->name}}"
 ...
 <div class="modal fade" id="edit_users_show" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
     ...
     <div class="modal-dialog">
         ...
         <div class="modal-content">
             ...
             <form action="{{route('admin.users.update',$user->id)}}" method="post" id="form_update_users" data-id="" enctype="multipart/form-data">
                     ...
                     <div class="container">
                         <div class="row">
                             <div class="form-group col-md-12"  style="text-align: @if(app()->getLocale() === 'ar' ) right @elseif(app()->getLocale() === "he") right @else left @endif">
                                 ...
                                 <input type="file" class="form-control users " id="users" name="users"  >
